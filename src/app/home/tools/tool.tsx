...
const tools = [
  ...
  { id: 7, icon: "/images/ladicdn/7.png", title: "Tính toán thời gian trả nợ theo lãi" },
  { id: 8, icon: "/images/ladicdn/8.png", title: "Payment Plan" },
];

const ToolItem = ({ icon, title }) => (
...
export default function Tool() {
  return (
    <div className="w-full h-full bg-[rgb(241,243,244)]  flex flex-col items-center mt-[150px] px-3">
      <div className="bg-[rgb(241,243,244)] w-full max-w-[960px] h-[600px] flex flex-col items-center justify-center  ">
        ...
        <div className="mt-[60px] text-center">
          <p className="text-[16px] font-bold text-black">
            Nếu bạn gặp bất cứ khó khăn nào khi sử dụng các công<br /> cụ hỗ trợ bạn có thể liên hệ trực tiếp với Tim Nguyen!
          </p>
        </div>
      </div>
    </div>
